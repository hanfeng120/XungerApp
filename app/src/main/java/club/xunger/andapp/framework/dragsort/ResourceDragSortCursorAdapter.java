...
package club.xunger.andapp.framework.dragsort;
...
public abstract class ResourceDragSortCursorAdapter extends DragSortCursorAdapter {
     ...
     *
     * @param context The context where the ListView associated with this adapter is
     *                running
     ...
     * @param autoRequery If true the adapter will call requery() on the cursor whenever
